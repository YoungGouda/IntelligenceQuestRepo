...
void Game::init(const char *title, int xpos, int ypos, int width, int height, bool fullscreen)
{
	...
	assets->AddFont("gilsans", "GIL_____.TTF", 16);

	map = new Map("terrain", 3, 32);

	map->LoadMap("iq_map_test.map", 25, 20);

	player.addComponent<TransformComponent>(800, 640, 64, 64, 1);
...
void Game::update() 
{
	...
	label.getComponent<UILabel>().SetLabelText(ss.str(), "gilsans");
